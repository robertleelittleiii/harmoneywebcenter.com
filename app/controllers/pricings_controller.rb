class PricingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pricing.save
        ...
        format.json { render :json=>@pricing.errors, :status=>:unprocessable_entry }
      end
    end
  end
  ...
  def destroy
   ...
   # CREATE_EMPTY_RECORD /pricings/1
   # CREATE_EMPTY_RECORD /pricings/1.json

  def create_empty_record
    @pricing = Pricing.new
    @pricing.save
    
    redirect_to(:controller=>:pricings, :action=>:edit, :id=>@pricing)
  end
